defmodule AwsAshWeb.CoreComponents do
  @moduledoc """
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 dark:shadow-zinc-100/10 dark:ring-zinc-100/10 relative hidden rounded-2xl bg-white dark:bg-black p-14 shadow-lg ring-1 transition"
            >
    ...
    <div>
      <label class="flex items-center gap-4 text-sm leading-6 text-zinc-600 dark:text-zinc-300">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class="rounded border-zinc-300 text-zinc-900 dark:text-zinc-100 focus:ring-0"
          {@rest}
        />
        {@label}
      </label>
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div>
      ...
      <select
        id={@id}
        name={@name}
        class="mt-2 block w-full rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-black shadow-sm focus:border-zinc-400 focus:dark:border-zinc-800 focus:ring-0 sm:text-sm"
        multiple={@multiple}
        {@rest}
      >
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "mt-2 block w-full rounded-lg text-zinc-900 dark:text-zinc-100 dark:bg-black focus:ring-0 sm:text-sm sm:leading-6 min-h-[6rem]",
      ...
      <table class="w-[40rem] mt-11 sm:w-full">
        ...
        >
          <tr
            ...
            class="group hover:bg-zinc-50 hover:dark:bg-zinc-800"
          >
            <td
            ...
            >
              <div class="block py-4 pr-6">
                <span class="absolute -inset-y-px right-0 -left-4 group-hover:bg-zinc-50 group-hover:dark:bg-zinc-800 sm:rounded-l-xl" />
            ...
            <td :if={@action != []} class="relative w-14 p-0">
              <div class="relative whitespace-nowrap py-4 text-right text-sm font-medium">
                <span class="absolute -inset-y-px -right-4 left-0 group-hover:bg-zinc-50 group-hover:dark:bg-zinc-800 sm:rounded-r-xl" />
                <span
                  :for={action <- @action}
                  class="relative ml-4 font-semibold leading-6 text-zinc-900 dark:text-zinc-100 hover:text-zinc-700 hover:dark:text-zinc-100"
                >
  ...
  def back(assigns) do
    ...
    <div class="mt-16">
      <.link
        navigate={@navigate}
        class="text-sm font-semibold leading-6 text-zinc-900 dark:text-zinc-100 hover:text-zinc-700 hover:dark:text-zinc-100"
      >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AwsAshWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AwsAshWeb.Gettext, "errors", msg, opts)
    end
  end
